...
void main() {
    ...
    if (state > 0.9) {
        ...
        // EXPLORED — dark tint
        gl_FragColor = vec4(${EXPLORED_R/255}.0, ${EXPLORED_G/255}.0, ${EXPLORED_B/255}.0, ${EXPLORED_ALPHA});
    } else {
...
export default class FogOfWar3D {
    ...
    constructor(scene, opts = {}) {
        ...
        // Combined render buffer (R channel only → RGB for DataTexture)
        this._texData     = new Uint8Array(TEX_SIZE * TEX_SIZE * 3);
    ...
    _buildTexture() {
        ...
        this._texture = new THREE.DataTexture(
            this._texData, TEX_SIZE, TEX_SIZE, THREE.RGBFormat,
        );
    ...
    update(dt, unitPositions) {
        ...
        // Build RGB texture: R = state (0=unexplored, 127=explored, 255=visible)

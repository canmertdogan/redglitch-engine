...
*   **New Dashboard:** The file `dashboard.html` will become the **RedGlitch Launcher**. This is the entry point.

## 2. The "Launcher" Design (New `dashboard.html`)
Inspired by Godot/Unreal/Photoshop start screens, but stylized for RedGlitch (Pixel Art/Cyberpunk).

...
**Objective:** Transform IRAB from a "Chatbot" into a fully agentic "Studio Operator" capable of manipulating the Vortex Engine tools (IsoPixel, Code Forge, World Builder) directly to fulfill user requests.

...
**Campaign Studio** is a powerful visual node-based editor for creating multi-engine game campaigns in ONGONLUK ENGINE. It enables seamless transitions between RPG-TopDown, ISO-Pixel, and Platformer-2D engines while maintaining player state, inventory, quests, and achievements throughout the journey.
...
1. Start ONGONLUK ENGINE launcher
...
Part of ONGONLUK ENGINE project.

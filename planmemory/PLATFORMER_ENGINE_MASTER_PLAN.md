...
**Goal:** Create a robust, feature-rich 2D platformer runtime (`platformer-2d`) compatible with the RedGlitch ecosystem.
...
**Format:**
Re-use standard RedGlitch JSON map format, but interpret layers differently:

# Vortex (Vortex) Engine - Codex Memory Report Card
...
- Naming inconsistency persists (Vortex vs Vortex) and shows up across docs and config.
...
## 8) Tech Debt Summary
- Inconsistent naming across Vortex/Vortex, Turkish vs English naming in paths.

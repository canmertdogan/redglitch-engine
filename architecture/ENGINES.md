...
redglitch ENGINE is a multi-paradigm system. It does not force a single rendering or logic style. Instead, it provides three distinct "Cores" or "Engines" that share the same Asset Manager and Event Bus.

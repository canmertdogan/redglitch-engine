...
The `public/` directory contains a vast array of specialized tools. ONGONLUK ENGINE follows the "Unix Philosophy": write programs that do one thing and do it well, communicating via the Event Bus.
